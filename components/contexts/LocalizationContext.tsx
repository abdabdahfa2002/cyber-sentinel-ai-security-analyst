...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    noTimelineEvents: 'No timeline events yet. Add your first event to get started.',
    moreEvents: '+{count} more events',
    aiEventAnalyzer: 'AI Event Analyzer',
    pasteEventLog: 'Paste Event Log or Raw Data',
    analyzeWithAI: 'Analyze with AI',
    foundEvents: 'Found {count} event(s) in your data',
    addEventsToTimeline: 'Add {count} Event(s) to Timeline',
  ...
  ar: {
    ...
    attackTimeline: 'الخط الزمني للهجوم',
    addEvent: 'إضافة حدث',
    fullView: 'عرض كامل',
    ...
    completeTimeline: 'الخط الزمني الكامل',
    noTimelineEvents: 'لا توجد أحداث في الخط الزمني حتى الآن. أضف حدثك الأول للبدء.',
    moreEvents: '+{count} أحداث إضافية',
    aiEventAnalyzer: 'محلل الأحداث بالذكاء الاصطناعي',
    pasteEventLog: 'الصق سجل الحدث أو البيانات الخام',
    analyzeWithAI: 'التحليل بالذكاء الاصطناعي',
    foundEvents: 'تم العثور على {count} حدث في بياناتك',
    addEventsToTimeline: 'إضافة {count} حدث إلى الخط الزمني',
    analyzeMore: 'تحليل المزيد',
    filters: 'المرشحات',
    allSeverities: 'جميع مستويات الخطورة',
    allCategories: 'جميع الفئات',
    clearFilters: 'مسح المرشحات',
    showingEvents: 'عرض {count} من {total} حدث',
    noEventsMatch: 'لا توجد أحداث تطابق المرشحات الخاصة بك.',
  },
};
